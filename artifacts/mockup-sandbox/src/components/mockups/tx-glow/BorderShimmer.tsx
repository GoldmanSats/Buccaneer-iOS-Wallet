  ...
  return (
    <div style={{ width: 390, height: 500, fontFamily: "'Nunito', sans-serif", display: "flex", flexDirection: "column", gap: 20, padding: 16 }}>
      <div style={{ fontSize: 11, fontWeight: 700, color: "#666", textAlign: "center", letterSpacing: 1, textTransform: "uppercase" }}>
        Option B: Left Border + Subtle Fill
      </div>
      <div style={{ fontSize: 11, color: "#999", textAlign: "center", marginTop: -16 }}>
        Colored left border accent with light tinted background, fades over ~2s
      </div>
      ...
      <div style={{ borderRadius: 20, overflow: "hidden", background: DARK.bgCard, padding: "16px 16px 8px", border: `1px solid ${DARK.border}` }}>
        ...
        <div style={{
          ...
          borderLeft: `3px solid ${DARK.teal}`,
          background: `rgba(23, 162, 184, 0.08)`,
          animation: "borderGlowDark 2s ease-out forwards",
        }}>
      ...
      <div style={{ borderRadius: 20, overflow: "hidden", background: LIGHT.bgCard, padding: "16px 16px 8px", border: `1px solid ${LIGHT.border}` }}>
        ...
        <div style={{
          display: "flex", alignItems: "center", gap: 12, padding: "10px 12px", borderRadius: 14,
          borderLeft: `3px solid ${LIGHT.tealDark}`,
          background: `rgba(13, 110, 125, 0.06)`,
          animation: "borderGlowLight 2s ease-out forwards",
        }}>
      ...
      <style>{`
        @keyframes borderGlowDark {
          0% { border-left-color: ${DARK.teal}; background: rgba(23,162,184,0.12); }
          60% { border-left-color: rgba(23,162,184,0.4); background: rgba(23,162,184,0.04); }
          100% { border-left-color: transparent; background: transparent; }
        }
        @keyframes borderGlowLight {
          0% { border-left-color: ${LIGHT.tealDark}; background: rgba(13,110,125,0.10); }
          60% { border-left-color: rgba(13,110,125,0.3); background: rgba(13,110,125,0.03); }
          100% { border-left-color: transparent; background: transparent; }
        }
      `}</style>
    </div>
