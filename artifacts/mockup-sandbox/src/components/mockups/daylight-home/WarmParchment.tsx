  ...
  return (
    <div style={{
      ...
      <div style={{ padding: "54px 20px 0", flex: 1, display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ display: "flex", gap: 16, padding: "24px 0", justifyContent: "center" }}>
          <div style={{
            ...
            <div style={{
              width: 52, height: 52, borderRadius: 26, background: "rgba(23,162,184,0.20)",
          ...
          <div style={{
            ...
            <div style={{
              width: 52, height: 52, borderRadius: 26, background: "rgba(232,106,51,0.20)",
              display: "flex", alignItems: "center", justifyContent: "center",
            }}>
      ...
      <div style={{
        ...
        background: C.gold, color: "#FFF", fontSize: 9, fontWeight: 700,
        padding: "2px 10px", borderRadius: 8, letterSpacing: 0.5,
      }}>A: WARM PARCHMENT</div>
    </div>
  );
}
