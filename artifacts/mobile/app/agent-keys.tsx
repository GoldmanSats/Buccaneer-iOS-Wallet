...
const styles = StyleSheet.create({
  ...
  explainerText: { flex: 1, fontFamily: "Inter_400Regular", fontSize: 13, color: "#CDDAED", lineHeight: 20 },
  createCard: {
    backgroundColor: NAVY_CARD,
    borderRadius: 16,
    padding: 20,
  ...
  createTitle: { fontFamily: "Inter_700Bold", fontSize: 16, color: "#FFFFFF", marginBottom: 4 },
  typeToggle: {
    flexDirection: "row",
  ...
  typeOptionText: { fontFamily: "Inter_600SemiBold", fontSize: 13, color: "#4A6080" },
  input: {
    backgroundColor: "#0D1830",
    borderRadius: 10,
    padding: 14,
  ...
  loadingText: { fontFamily: "Inter_400Regular", fontSize: 14, color: "#4A6080" },
  emptyState: { alignItems: "center", paddingVertical: 60, gap: 10 },
  emptyTitle: { fontFamily: "Inter_600SemiBold", fontSize: 16, color: "#8FA3C8" },
  emptySubtitle: { fontFamily: "Inter_400Regular", fontSize: 13, color: "#4A6080", textAlign: "center" },
  keysList: { gap: 12 },
  keyCard: {
    backgroundColor: NAVY_CARD,
    borderRadius: 16,
  ...
  keyName: { fontFamily: "Inter_700Bold", fontSize: 16, color: "#FFFFFF" },
  keyDate: { fontFamily: "Inter_400Regular", fontSize: 11, color: "#4A6080" },
  ...
  limitBadgeText: { fontFamily: "Inter_500Medium", fontSize: 11, color: GOLD },
  uriRow: {
    flexDirection: "row",
    alignItems: "center",
    gap: 8,
  ...
  uriText: { flex: 1, fontFamily: "Inter_400Regular", fontSize: 12, color: "#4A6080", letterSpacing: 0.3 },
  ...
  logsSectionTitle: { fontFamily: "Inter_600SemiBold", fontSize: 13, color: "#8FA3C8" },
  logRow: {
    flexDirection: "row",
    alignItems: "center",
    gap: 10,
  ...
  logAction: { fontFamily: "Inter_500Medium", fontSize: 12, color: "#CDDAED" },
  logDetail: { fontFamily: "Inter_400Regular", fontSize: 11, color: "#4A6080" },
  logTime: { fontFamily: "Inter_400Regular", fontSize: 10, color: "#4A6080" },
  logEmpty: { fontFamily: "Inter_400Regular", fontSize: 12, color: "#4A6080", textAlign: "center", paddingVertical: 8 },
  deleteBtn: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "center",
  ...
  deleteBtnText: { fontFamily: "Inter_600SemiBold", fontSize: 13, color: "#E63946" },
});
