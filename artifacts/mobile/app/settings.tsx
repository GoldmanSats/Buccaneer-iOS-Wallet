...
const styles = StyleSheet.create({
  ...
  rowLabel: { fontFamily: "Nunito_600SemiBold", fontSize: 15, color: "#FFFFFF" },
  rowSubtitle: { fontFamily: "Nunito_400Regular", fontSize: 12, color: "#4A6080" },
  addressCard: {
    flexDirection: "row",
    alignItems: "center",
    gap: 10,
  ...
  addressText: { flex: 1, fontFamily: "Nunito_500Medium", fontSize: 14, color: "#CDDAED" },
  addressEditCard: {
    backgroundColor: NAVY_CARD,
    borderRadius: 16,
    padding: 16,
  ...
  addressCancelText: { fontFamily: "Nunito_500Medium", fontSize: 14, color: "#4A6080" },
  addressSaveBtn: { paddingHorizontal: 16, paddingVertical: 8, backgroundColor: GOLD, borderRadius: 8 },
  addressSaveText: { fontFamily: "Nunito_700Bold", fontSize: 14, color: NAVY },
  iconBtn: {
    width: 36,
    height: 36,
    borderRadius: 8,
  ...
  currencyText: { fontFamily: "Nunito_600SemiBold", fontSize: 13, color: "#CDDAED" },
  currencyPicker: {
    flexDirection: "row",
    flexWrap: "wrap",
    gap: 8,
  ...
  currencyOptionText: { fontFamily: "Nunito_500Medium", fontSize: 13, color: "#8FA3C8" },
  toggleGroup: {
    flexDirection: "row",
    backgroundColor: "#0D1830",
    borderRadius: 8,
  ...
  toggleText: { fontFamily: "Nunito_600SemiBold", fontSize: 12, color: "#4A6080" },
  ...
  deleteCancelText: { fontFamily: "Nunito_600SemiBold", fontSize: 14, color: "#8FA3C8" },
  deleteConfirmBtn: {
    paddingHorizontal: 24,
    paddingVertical: 12,
    borderRadius: 10,
